    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="text-center" id="callCenterTitle"> POINTAGE </h1>

                <div id="timeChecker" class="well">


                    <div class="text-center " id="appLauncher">
                        <a  href="timeCheckerDisplay.php" class="btn btn-info linkToModule"> DEMARRER</a>
                    </div>
